...
class TestRescanTool:
    ...
    def test_execute_rescan_all(self, tmp_path: Path) -> None:
        ...
        with patch("code2doc_core.scanner.project_scanner.ProjectScanner", return_value=mock_scan):
            with patch("code2doc_core.scanner.change_detector.ChangeDetector") as MockDetector:
